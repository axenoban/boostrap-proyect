<section class="hero-subpage d-flex align-items-center justify-content-center text-white" style="background-image: url('https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=1600&q=80');" data-aos="fade-in">
    <div class="container text-center py-5">
        ...
        <div class="d-flex gap-3 justify-content-center flex-wrap" data-aos="fade-up" data-aos-delay="300">
            <a href="#naturales" class="btn btn-outline-light btn-lg">Explorar catálogo</a>
            <a href="index.php?page=cliente-login" class="btn btn-accent btn-lg">Portal de reservas</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row g-4 align-items-center">
            <div class="col-lg-6" data-aos="fade-right">
                <h2 class="display-5 fw-bold text-primary-dark mb-3">Catálogo curado para tus colecciones</h2>
                <p class="text-secondary-dark">Seleccionamos constantemente los tejidos más solicitados para moda, decoración e industria. Cada ficha incluye medidas, composición y recomendaciones de uso para que tomes decisiones rápidas.</p>
                <ul class="list-unstyled mt-4">
                    <li class="d-flex gap-3 mb-3">
                        <i class="fas fa-warehouse text-accent mt-1"></i>
                        <span>Inventario referencial actualizado con entregas en 48 horas en Santa Cruz.</span>
                    </li>
                    <li class="d-flex gap-3 mb-3">
                        <i class="fas fa-palette text-accent mt-1"></i>
                        <span>Mínimo 12 variaciones cromáticas por familia de producto.</span>
                    </li>
                    <li class="d-flex gap-3">
                        <i class="fas fa-box-open text-accent mt-1"></i>
                        <span>Servicios de corte previo y logística coordinada con tu asesor comercial.</span>
                    </li>
                </ul>
            </div>
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4">
            ...
            <div class="col" data-aos="zoom-in" data-aos-delay="200">
                <div class="card h-100 border-0 shadow-sm text-center p-4">
                    ...
                    <p class="text-secondary-dark mb-0">Verifica medidas, composición y fotos de referencia.</p>
                </div>
            </div>
            ...
            <div class="col" data-aos="zoom-in" data-aos-delay="400">
                <div class="card h-100 border-0 shadow-sm text-center p-4">
                    ...
                    <p class="text-secondary-dark mb-0">Coordinamos retiro o envío y confirmamos la programación.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <ul class="list-unstyled mt-4">
                    ...
                    <li class="d-flex gap-3">
                        ...
                        <span>Servicios de corte previo y fichas técnicas descargables.</span>
                    </li>
                </ul>
            </div>
            <div class="col-lg-6" data-aos="fade-left">
